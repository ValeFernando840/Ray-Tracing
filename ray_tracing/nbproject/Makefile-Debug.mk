...
${OBJECTDIR}/Principal.o: Principal.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Principal.o Principal.for

${OBJECTDIR}/Sub_Back_Up.o: Sub_Back_Up.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Back_Up.o Sub_Back_Up.for

${OBJECTDIR}/Sub_Carpol.o: Sub_Carpol.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Carpol.o Sub_Carpol.for

${OBJECTDIR}/Sub_ELectx2.o: Sub_ELectx2.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_ELectx2.o Sub_ELectx2.for

${OBJECTDIR}/Sub_Elect1.o: Sub_Elect1.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Elect1.o Sub_Elect1.for

${OBJECTDIR}/Sub_Frec_plasma.o: Sub_Frec_plasma.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Frec_plasma.o Sub_Frec_plasma.for

${OBJECTDIR}/Sub_Graze.o: Sub_Graze.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Graze.o Sub_Graze.for

${OBJECTDIR}/Sub_Grid.o: Sub_Grid.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Grid.o Sub_Grid.for

${OBJECTDIR}/Sub_Hamltn.o: Sub_Hamltn.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Hamltn.o Sub_Hamltn.for

${OBJECTDIR}/Sub_Latlon.o: Sub_Latlon.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Latlon.o Sub_Latlon.for

${OBJECTDIR}/Sub_Polcoe.o: Sub_Polcoe.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Polcoe.o Sub_Polcoe.for

${OBJECTDIR}/Sub_Porcar.o: Sub_Porcar.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Porcar.o Sub_Porcar.for

${OBJECTDIR}/Sub_Reach.o: Sub_Reach.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Reach.o Sub_Reach.for

${OBJECTDIR}/Sub_Rindex.o: Sub_Rindex.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Rindex.o Sub_Rindex.for

${OBJECTDIR}/Sub_Rkam.o: Sub_Rkam.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Rkam.o Sub_Rkam.for

${OBJECTDIR}/Sub_Trace.o: Sub_Trace.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Trace.o Sub_Trace.for

${OBJECTDIR}/Sub_Zero.o: Sub_Zero.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_Zero.o Sub_Zero.for

${OBJECTDIR}/Sub_cira.o: Sub_cira.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_cira.o Sub_cira.for

${OBJECTDIR}/Sub_igrf.o: Sub_igrf.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_igrf.o Sub_igrf.for

${OBJECTDIR}/Sub_iridreg.o: Sub_iridreg.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_iridreg.o Sub_iridreg.for

${OBJECTDIR}/Sub_iriflip.o: Sub_iriflip.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_iriflip.o Sub_iriflip.for

${OBJECTDIR}/Sub_irifun.o: Sub_irifun.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_irifun.o Sub_irifun.for

${OBJECTDIR}/Sub_irisub.o: Sub_irisub.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_irisub.o Sub_irisub.for

${OBJECTDIR}/Sub_iritec.o: Sub_iritec.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_iritec.o Sub_iritec.for

${OBJECTDIR}/Sub_read_W.o: Sub_read_W.for
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -g -o ${OBJECTDIR}/Sub_read_W.o Sub_read_W.for
